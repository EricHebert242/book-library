...
export function BookForm({ book, isEditing = false, defaultAuthorId = "" }: BookFormProps) {
  ...
  // Use the provided defaultAuthorId or get it from searchParams
  const authorIdFromUrl = searchParams ? searchParams.get("authorId") : null
  ...
  const form = useForm<z.infer<typeof formSchema>>({
    ...
    defaultValues: {
      ...
      authorId: book?.authorId || defaultAuthorId || authorIdFromUrl || "",
    },
  })
